...
flow.set_fg(fg=fg,sigma=args.sigma,chromatic=args.chromatic,
...
for vs in ['A','W','N']:
    ...
    likelihood1d=flow.get_likelihood(t21vsdata1d,args.freqFluctuationLevel,args.DA_factor,debugfF=True)
    lname=nf.get_lname(args,plot=vs)
