...
width=np.linspace(5.0,20.0,num=l2.shape[0]) #default is 14
nu_min=np.linspace(5.0,25.0, num=l2.shape[0]) #default is 16.4
...
for iv,v in enumerate(vs):
    for iaa,aa in enumerate(a):
        ...
        print(f'{t21data.shape=}, {flow.t21data.shape=}, {flow.fgmeansdata.shape=}')
