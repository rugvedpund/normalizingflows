...
fgfreqs = "50-100" if cosmicdawn else "1-50"
...
snrpps = [1e24,1e5,1e6] if cosmicdawn else [1e24, 1e5, 1e7]
...
plt.title(f"CMB Monopole Likelihood for {fgfreqs} MHz")
plt.legend()
